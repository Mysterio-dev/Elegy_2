 ...
 */
    ...
    (() => {
        ...
        let genplanScheme = document.querySelectorAll(".genplan__scheme > path");
        genplanScheme.forEach((function(path) {
        ...
        window.addEventListener("click", (function(e) {
            if (null === e.target.closest(".genplan__object")) closeObject();
        }));
        function closeObject() {
            document.querySelectorAll(".genplan__object").forEach((function(container) {
                container.classList.remove("_active");
            }));
        }
        tippy(".genplan__object", {
            allowHTML: true,
